...
[_QWERTY] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, LOWER,   KC_LSFT, KC_SPC,  RAISE,  XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX
),

[_NAV] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, _______, _______, _______,LCTL_T(KC_LALT),_______,HMSPN, RAYCAST, _______, _______, _______, _______,
